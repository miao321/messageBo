...
<div class="navbar navbar-default navbar-fixed-top" style="background:#272727;color:white" >
	...
	<div id="articleModifyForm">
		...
		<div class="form_foot">
			<input type="submit" style="width:60px;height:30px;margin-left:50px;padding:2px 4px;margin-top:10px;margin-bottom:10px;font-weight: bold;" value"评论" onclick="doInsert()">
		</div>
	</div>	
</body>
</html>